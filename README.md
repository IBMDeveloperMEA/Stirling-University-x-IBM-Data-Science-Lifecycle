# Stirling University x IBM: Data Science Lifecycle

## Workshop Resources

- Login/Sign Up for IBM Cloud: https://ibm.biz/StirlingDSL
  
- Hands-On Guide: https://ibm.biz/StirlingDSL-HandsOn

- Slides: https://ibm.biz/StirlingDSL-Slides

- Workshop replay: https://www.crowdcast.io/e/stirling-university-x/
...
If you are an existing user please [login to IBM Cloud](https://cloud.ibm.com/registration/trial?utm_medium=Inpersondirected&utm_content=000039JL&utm_term=10010797&utm_id=Nov2021-stirlinguniversityxibmdatasciencelifecycle-eventid-61701c565a388d4b12404fc2-global-devadvgrp-dubai-hybrid-workshop-dubai)

And if you are not, don't worry! We have got you covered! There are 3 steps to create your account on [IBM Cloud](https://cloud.ibm.com/registration/trial?utm_medium=Inpersondirected&utm_content=000039JL&utm_term=10010797&utm_id=Nov2021-stirlinguniversityxibmdatasciencelifecycle-eventid-61701c565a388d4b12404fc2-global-devadvgrp-dubai-hybrid-workshop-dubai): <br>
...
``` 
git clone https://github.com/IBMDeveloperMEA/Stirling-University-x-IBM-Data-Science-Lifecycle
```

To download this repository, click [here](https://github.com/IBMDeveloperMEA/Stirling-University-x-IBM-Data-Science-Lifecycle/archive/refs/heads/main.zip) Or click on the green code icon, and download the ZIP file. You will need the repository for the data that is required for this tutorial.
...
**In the case where you don't have a machine learning service associated**
 ...
 ![associateML2](/images/associate2.png)
